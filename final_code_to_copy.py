# 🚀 PLATEFORME IA GRATUITE À VIE - CODE COMPLET 🚀
# Copie ce code dans Google Colab et exécute-le !

print("🔧 Installation des outils magiques...")
!pip install streamlit pyngrok SpeechRecognition pydub gtts pillow requests beautifulsoup4 python-docx PyPDF2 -q
...
if tool_choice == "🏠 Accueil":
    ...
    audio_file = st.file_uploader("Choisis ton fichier audio", type=['wav'])
...
# Créer le fichier de l'application
...
# Importer les outils pour l'URL publique
...
# Créer l'URL publique avec ngrok
...
try:
    ...
    print("\n🔄 Application active... L'URL fonctionne maintenant !")
